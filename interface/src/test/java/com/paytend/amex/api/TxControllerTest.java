...
class TxControllerTest {
    ...
    @Mock
    public AmexAuthCommandService amexAuthCommandService;
    ...
    public void auth() {
        ...
        MockMvc mockMvc = MockMvcBuilders.standaloneSetup(new TxController(amexAuthCommandService)).build();
        ...
        try {
            ...
            Mockito.when(amexAuthCommandService.auth(any(AuthorizationDto.class), any(TxHeader.class))).thenReturn(new AuthorizationRspDto());
    ...
    public void auth1() throws JsonProcessingException {
        ...
        AuthorizationDto authorization = mapper.readValue(jsonString, AuthorizationDto.class);
        MockMvc mockMvc = MockMvcBuilders.standaloneSetup(new TxController(amexAuthCommandService)).build();
