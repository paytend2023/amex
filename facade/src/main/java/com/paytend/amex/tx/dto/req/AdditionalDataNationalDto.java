...
@Getter
@Setter
public class AdditionalDataNationalDto {


    CardNotPresentDataDto CardNotPresentData;

    InternetAirlineCustomerDto InternetAirlineCustomer;

    CardPresentDataDto CardPresentData;

    @Tolerate
    public AdditionalDataNationalDto(){}
